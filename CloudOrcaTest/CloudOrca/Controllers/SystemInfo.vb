...
Public Class SystemInfo
    ...
    Public Function Main(ByVal args() As String) As String
        ...
        ' Version4.7
        Dim FULLURL As String = "https://" + HOST + ":" + PORT + URL
        ...
        Dim strPostData As String = String.Format("<data><private_objects type=""record""><Request_Date type=""string"">{0}</Request_Date><Request_Time type=""string"">{1}</Request_Time></private_objects></data>", Now.AddDays(-1).ToString("yyyy-MM-dd"), Now.ToString("HH:mm:ss"))
        'Dim postData As String = System.Web.HttpUtility.UrlEncode(strPostData, enc)
        'byte[] byteArray = Encoding.UTF8.GetBytes (postData);  
        'バイト型配列に変換
        'Dim postDataBytes As Byte() = System.Text.Encoding.ASCII.GetBytes(postData)
        Dim postDataBytes As Byte() = System.Text.Encoding.UTF8.GetBytes(strPostData)
        rtn += strPostData
